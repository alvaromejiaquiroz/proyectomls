<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="ListaFrancosCompensatorios.aspx.cs" Inherits="Solicitudes_ListaFrancosCompensatorios" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContainer" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" 
        ...
        <asp:BoundField DataField="ConElConsentimiento" HeaderText="Con el Consentimiento" />
